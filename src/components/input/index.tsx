...
const InputBase: ForwardRefRenderFunction<HTMLInputElement, IInput> = ({placeholder, type, error, icon, ...rest}, ref) => {
    return(
        <div className="flex flex-wrap w-full items-center mb-6">
            <label className="relative w-full flex items-center">
                ...
                <input 
                    ...
                    type={type} 
                    {...rest} 
                    className='w-full sm:py-2 sm:px-7 md:py-[0.7rem] md:px-[2.2rem] rounded-lg border-[1px] border-gray-50 border-solid bg-white sm:text-sm md:text-base' 
                />
            </label>
